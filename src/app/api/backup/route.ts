  ...
  try {
    ...
    for (const e of body.events) {
      await db.insert(events).values({
        ...
        musicianName: e.musicianName ?? null,
        musicianInstrument: e.musicianInstrument ?? null,
        musicianPhone: e.musicianPhone ?? null,
        musicianFee: e.musicianFee ?? 0,
        colleagueName: e.colleagueName ?? null,
        colleagueRole: e.colleagueRole ?? null,
        colleaguePhone: e.colleaguePhone ?? null,
        colleagueFee: e.colleagueFee ?? 0,
        musiciansJson: e.musiciansJson ?? null,
        providersJson: e.providersJson ?? null,
        colleaguesJson: e.colleaguesJson ?? null,
