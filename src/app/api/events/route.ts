  ...
  try {
    ...
    const result = await db
      ...
      .values({
        ...
        musicianName: body.musicianName || null,
        musicianInstrument: body.musicianInstrument || null,
        musicianPhone: body.musicianPhone || null,
        musicianFee: Number(body.musicianFee) || 0,
        colleagueName: body.colleagueName || null,
        colleagueRole: body.colleagueRole || null,
        colleaguePhone: body.colleaguePhone || null,
        colleagueFee: Number(body.colleagueFee) || 0,
        musiciansJson: body.musiciansJson ? String(body.musiciansJson) : null,
        providersJson: body.providersJson ? String(body.providersJson) : null,
        colleaguesJson: body.colleaguesJson ? String(body.colleaguesJson) : null,
